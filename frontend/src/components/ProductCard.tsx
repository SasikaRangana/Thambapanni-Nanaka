    ...
    <article className="group relative rounded-2xl bg-[#15110d] border border-[#d4af37]/25 hover:border-[#d4af37]/70 overflow-hidden flex flex-col justify-between transition-all duration-400 hover:-translate-y-2 luxury-card-glow">
      ...
      >
        ...
        <div className="absolute top-3 left-3 right-3 flex items-center justify-between pointer-events-none z-20">
          <span className="px-2.5 py-1 rounded-md bg-black/80 backdrop-blur-md border border-[#d4af37]/40 text-[10px] font-mono font-semibold text-[#f3e5ab] uppercase tracking-wider shadow-sm">
            {item.itemCode}
          </span>

          <div className="flex items-center gap-1.5">
            {images.length > 1 && (
              <span className="px-2 py-1 rounded-md bg-black/85 backdrop-blur-md border border-[#d4af37]/40 text-[10px] font-mono font-bold text-[#f3e5ab] flex items-center gap-1 shadow-sm">
                <Images className="w-3 h-3 text-[#d4af37]" />
                <span>{images.length} Photos</span>
              </span>
            )}
            <span
              className={`px-2.5 py-1 rounded-md text-[10px] font-mono font-bold uppercase tracking-wider shadow-sm ${
                item.is_sold
                  ? "bg-rose-950/85 text-rose-300 border border-rose-600/40"
        ...
        {images.length > 1 && (
          <button
            onClick={handleFlip}
            className="absolute bottom-3 left-3 z-20 px-2.5 py-1.5 rounded-lg bg-black/85 hover:bg-[#d4af37] text-[#f3e5ab] hover:text-[#0c0a08] border border-[#d4af37]/40 text-[10px] font-mono font-semibold flex items-center gap-1.5 transition-all shadow-md active:scale-95"
        ...
        <button
          ...
          className={`absolute bottom-3 right-3 z-20 p-2 rounded-full border transition-all shadow-lg active:scale-90 ${
            wishlisted
        ...
        <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/40 backdrop-blur-[2px] z-20">
          <span className="px-4 py-2 rounded-full bg-[#1c1711] border border-[#d4af37] text-xs font-mono text-[#f3e5ab] flex items-center gap-2 shadow-2xl">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
        <div>
          ...
          <div className="mt-2.5 flex items-center gap-2">
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-md bg-[#221b13] border border-[#d4af37]/30 text-[11px] font-mono text-[#f3e5ab] shadow-sm">
        ...
        <div className="pt-3 border-t border-[#d4af37]/15 flex items-center justify-between gap-3">
          <div>
            ...
            <span className="font-serif text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#f3e5ab] via-[#d4af37] to-[#e5c158]">
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-semibold bg-emerald-600 hover:bg-emerald-500 text-white transition-all shadow-md hover:shadow-emerald-900/40 active:scale-95 shrink-0"
